...
public class SceneReference : ISerializationCallbackReceiver
{
    ...
    //Von mir hinzugefügt. Sollte eigentlich nie nötig sein, von daher wieder auskommentiert.
    //public string SceneName => ScenePath == string.Empty ? string.Empty : Path.GetFileNameWithoutExtension(ScenePath);
