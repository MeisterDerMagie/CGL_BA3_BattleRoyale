...
namespace FullSerializer {
    public class fsSerializer {
        ...
        /// </summary>
        private static readonly string Key_InstanceType = string.Format("{0}t", fsGlobalConfig.InternalFieldPrefix); //originally: "{0}type"

        /// <summary>
        /// The version string for the serialized data.
        /// </summary>
        private static readonly string Key_Version = string.Format("{0}v", fsGlobalConfig.InternalFieldPrefix); //originally: "{0}version"
        ...
        /// </summary>
        private static readonly string Key_Content = string.Format("{0}c", fsGlobalConfig.InternalFieldPrefix); //originally: "{0}content"
